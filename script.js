...
% STREAMING_CHUNK:Kode sw.js

4. sw.js

Buat file sw.js (Service Worker) di folder utama. Ini akan menyimpan cache agar undangan bisa dibuka meski tamu offline atau koneksinya lambat.
